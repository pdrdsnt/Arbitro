...
export function toStyledCharacters(text) {
    ...
    for (let i = 0; i < characters.length; i++) {
        ...
        while (i + 1 < characters.length) {
            ...
            // Variation selectors
            const isVariationSelector = nextFirstCodePoint >= 0xfe_00 && nextFirstCodePoint <= 0xfe_0f;
            // Skin tone modifiers
            ...
            const isCombiningMark = nextFirstCodePoint >= 0x03_00 && nextFirstCodePoint <= 0x03_6f;
            const isCombining = isVariationSelector ||
                isSkinToneModifier ||
                isZeroWidthJoiner ||
                isKeycap ||
                isTagsBlock ||
