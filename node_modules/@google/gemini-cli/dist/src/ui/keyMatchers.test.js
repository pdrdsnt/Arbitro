...
describe('keyMatchers', () => {
    ...
    const originalMatchers = {
        ...
        [Command.SCROLL_UP]: (key) => key.name === 'up' && !!key.shift,
        [Command.SCROLL_DOWN]: (key) => key.name === 'down' && !!key.shift,
        [Command.SCROLL_HOME]: (key) => key.name === 'home',
        [Command.SCROLL_END]: (key) => key.name === 'end',
        [Command.PAGE_UP]: (key) => key.name === 'pageup',
        [Command.PAGE_DOWN]: (key) => key.name === 'pagedown',
        ...
        [Command.DIALOG_NAVIGATION_UP]: (key) => !key.shift && (key.name === 'up' || key.name === 'k'),
        [Command.DIALOG_NAVIGATION_DOWN]: (key) => !key.shift && (key.name === 'down' || key.name === 'j'),
        ...
        [Command.SHOW_ERROR_DETAILS]: (key) => key.name === 'f12',
        [Command.SHOW_FULL_TODOS]: (key) => key.ctrl && key.name === 't',
        [Command.TOGGLE_IDE_CONTEXT_DETAIL]: (key) => key.ctrl && key.name === 'g',
        [Command.TOGGLE_MARKDOWN]: (key) => key.meta && key.name === 'm',
        [Command.TOGGLE_COPY_MODE]: (key) => key.ctrl && key.name === 's',
        ...
        [Command.TOGGLE_SHELL_INPUT_FOCUS]: (key) => key.ctrl && key.name === 'f',
        [Command.EXPAND_SUGGESTION]: (key) => key.name === 'right',
        [Command.COLLAPSE_SUGGESTION]: (key) => key.name === 'left',
    };
