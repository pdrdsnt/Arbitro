...
describe(`useKeypress`, () => {
    ...
    const renderKeypressHook = (isActive = true) => {
        ...
        return render(_jsx(KeypressProvider, { children: _jsx(TestComponent, {}) }));
    };
    beforeEach(() => {
        vi.clearAllMocks();
        vi.useFakeTimers();
    ...
    it('should correctly identify alt+enter (meta key)', () => {
        ...
        act(() => stdin.write(key.sequence));
        expect(onKeypress).toHaveBeenCalledWith(expect.objectContaining({ ...key, meta: true, paste: false }));
    });
    describe.each([
        {
        ...
        it('should handle keypress interspersed with pastes', () => {
            ...
            act(() => stdin.write('a'));
            expect(onKeypress).toHaveBeenCalledWith(expect.objectContaining({ ...keyA, paste: false }));
            const pasteText = 'pasted';
            act(() => stdin.write(PASTE_START + pasteText + PASTE_END));
            expect(onKeypress).toHaveBeenCalledWith(expect.objectContaining({ paste: true, sequence: pasteText }));
        ...
        it('should handle back to back pastes', () => {
            ...
            expect(onKeypress).toHaveBeenCalledWith(expect.objectContaining({ paste: true, sequence: pasteText1 }));
            expect(onKeypress).toHaveBeenCalledWith(expect.objectContaining({ paste: true, sequence: pasteText2 }));
            expect(onKeypress).toHaveBeenCalledTimes(2);
        });
...
//# sourceMappingURL=useKeypress.test.js.map