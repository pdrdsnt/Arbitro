...
describe('useShellCommandProcessor', () => {
    ...
    const renderProcessorHook = () => {
        ...
        function TestComponent() {
            hookResult = useShellCommandProcessor(addItemToHistoryMock, setPendingHistoryItemMock, onExecMock, onDebugMessageMock, mockConfig, mockGeminiClient, setShellInputFocusedMock);
            return null;
        }
