...
export function createCustomTheme(customTheme) {
    const colors = {
        ...
        DarkGray: customTheme.DarkGray ??
            interpolateColor(customTheme.text?.secondary ?? customTheme.Gray ?? '', customTheme.background?.primary ?? customTheme.Background ?? '', 0.5),
    ...
    const semanticColors = {
        text: {
            ...
            response: customTheme.text?.response ??
