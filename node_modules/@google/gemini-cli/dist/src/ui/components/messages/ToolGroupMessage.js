    ...
    _jsxs(Box, { flexDirection: "column", 
        ...
        */
        width: terminalWidth, children: [toolCalls.map((tool, index) => {
                ...
                return (_jsxs(Box, { flexDirection: "column", minHeight: 1, width: terminalWidth, children: [_jsx(ToolMessage, { ...tool, availableTerminalHeight: availableTerminalHeightPerToolMessage, terminalWidth: terminalWidth, emphasis: isConfirming ? 'high' : toolAwaitingApproval ? 'low' : 'medium', activeShellPtyId: activeShellPtyId, embeddedShellFocused: embeddedShellFocused, config: config, isFirst: isFirst, borderColor: borderColor, borderDimColor: borderDimColor }), _jsxs(Box, { borderLeft: true, borderRight: true, borderTop: false, borderBottom: false, borderColor: borderColor, borderDimColor: borderDimColor, flexDirection: "column", borderStyle: "round", paddingLeft: 1, paddingRight: 1, children: [tool.status === ToolCallStatus.Confirming &&
                                    isConfirming &&
