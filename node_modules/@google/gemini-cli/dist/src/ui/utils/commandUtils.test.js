    ...
    describe('copyToClipboard', () => {
        ...
        describe('on Linux', () => {
            ...
            it('should handle command failure on Linux via "exit" event', async () => {
                ...
                await expect(copyToClipboard(testText)).rejects.toThrow('All copy commands failed. "\'xclip\' exited with code 127: xclip failed", "\'xsel\' exited with code 127: xsel failed".');
