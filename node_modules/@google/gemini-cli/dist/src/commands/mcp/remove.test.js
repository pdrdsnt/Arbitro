...
describe('mcp remove command', () => {
    describe('unit tests with mocks', () => {
        ...
        it('should show a message if server not found', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('Server "non-existent-server" not found in project settings.');
        });
    });
    describe('integration tests with real file I/O', () => {
        ...
        "mcpServers": {
          ...
          "server-to-remove": {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('Server "server-to-remove" removed from project settings.');
