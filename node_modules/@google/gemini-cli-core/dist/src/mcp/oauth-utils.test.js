...
describe('OAuthUtils', () => {
    ...
    describe('buildResourceParameter', () => {
        ...
        it('should strip query parameters from the URL', () => {
            const result = OAuthUtils.buildResourceParameter('https://example.com/api/v1/data?user=123&scope=read');
            expect(result).toBe('https://example.com/api/v1/data');
        });
        it('should strip URL fragments from the URL', () => {
            const result = OAuthUtils.buildResourceParameter('https://example.com/api/v1/data#section-one');
            expect(result).toBe('https://example.com/api/v1/data');
        });
