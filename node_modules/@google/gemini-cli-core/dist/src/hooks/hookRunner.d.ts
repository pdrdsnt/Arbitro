...
export declare class HookRunner {
     ...
     */
    executeHooksParallel(hookConfigs: HookConfig[], eventName: HookEventName, input: HookInput): Promise<HookExecutionResult[]>;
    /**
     * Execute multiple hooks sequentially
     */
    executeHooksSequential(hookConfigs: HookConfig[], eventName: HookEventName, input: HookInput): Promise<HookExecutionResult[]>;
    /**
