...
use crate::{err::PoolUpdateError, mult_provider::MultiProvider, token::Token, trade::Trade, v2_pool_sim::V2PoolSim};
...
impl V2PoolSrc {
    // Private constructor
    async fn new(
        exchange: String, version: String, fee: u32, address: Address, token0: Arc<RwLock<Token,>,>, token0_addr: H160,
        token1: Arc<RwLock<Token,>,>, token1_addr: H160, contract: Contract<Provider<MultiProvider,>,>,
    ) -> Self {
