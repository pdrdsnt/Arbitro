...
impl ChainSrc {
    ...
    pub async fn search_pool(
        abis: Arc<AbisData>, provider: Arc<Provider<MultiProvider>>,
        factory: Arc<RwLock<AnyFactory>>, fee: u32, token0: Arc<RwLock<Token>>,
        ...
        let discovered = DiscoveredPool { address: va, pool: pool_arc };
